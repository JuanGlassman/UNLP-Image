...
def me (perfil):
    ...
    barra_principal = [[sg.Column(boton_imagen, element_justification='left', expand_x=True),sg.Column(boton_ayuda, element_justification='rigth', expand_x=True)]
    ...
    layout = [
        [barra_principal],
        #[sg.Column(boton_ayuda, element_justification='rigth', expand_x=True)],
        #[sg.Column(boton_imagen, element_justification='left', expand_x=True)],
    ...
    while True:
        ...
        if event == 'editar_perfil':
            perfil_editar.editar_perfil(perfil)
            window.refresh()
