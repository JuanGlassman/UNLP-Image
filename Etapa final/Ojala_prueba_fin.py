...
layout = [[sg.Text('UNLP-Image', size=(50, 2), font=('Times New Roman', 75), text_color='Black', justification=("c"))],
        ...
        [boton_ver_mas], 
        [sg.Button(image_data=abrir_foto(ruta_fotos), image_size=(150,150),border_width=0, key='menu')],
...
while True:
    ...
    if event == ("ver_mas"):
        mostrar_lista()  
    if event == ("menu"):
        menu.me(lista_imagenes[len(lista_imagenes)-1])
window.close()