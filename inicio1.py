...
ruta_fotos1 = convert_to_bytes(os.path.join(os.getcwd(),"Fotos","gatopng.png"))
ruta_fotos2= convert_to_bytes(os.path.join(os.getcwd(),"Fotos","gatopng2.png"))
ruta_fotos3= convert_to_bytes(os.path.join(os.getcwd(),"Fotos","perro.jpg"))
ruta_fotos4= convert_to_bytes(os.path.join(os.getcwd(),"Fotos","Gato1.jpg"))
...
def perfiles(lista_fotos):
    ...
    botonera.append(sg.Button('+', size=(5, 2), button_color=('white', 'grey'), font=('Helvetica', 25)))
    return botonera
